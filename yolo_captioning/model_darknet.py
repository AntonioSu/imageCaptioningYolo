...
from utils_one_feature.parse_config import *
from utils_one_feature.utils import build_targets, to_cpu, non_max_suppression
...
class Darknet(nn.Module):
    ...
    def forward(self, x, targets=None):
        ...
        return (yolo_outputs,output_tesor) if targets is None else (loss, yolo_outputs)
