...
class EncoderCNN(nn.Module):
    def __init__(self,reso, cuda=torch.cuda.is_available()):
        ...
        self.model.load_state_dict(torch.load("checkpoints/yolov3_ckpt_50.pth"))
        self.CUDA=cuda
    ...
    def forward(self, images):
        ...
        # assert inp_dim % 32 == 0
        # assert inp_dim > 32
        prediction, feature = self.model(images)
...
class AttnDecoderRNN(nn.Module):
    ...
    def forward(self, encoder_out, encoded_captions, caption_lengths,detection_box):
        """
